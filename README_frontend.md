...
Implementar operaciones CRUD (Create, Read, Update, Delete) desde el frontend
Manejar estados de la aplicación y respuestas asíncronas
Validar formularios y datos de entrada
Gestionar errores y proporcionar retroalimentación al usuario
...
Asegúrate de que el proyecto lp3-taller2 esté ejecutándos, verifica que la API responda en: http://127.0.0.1:8000/docs
